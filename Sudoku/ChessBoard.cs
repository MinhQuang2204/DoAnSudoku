...
{  
    public class ChessBoard
    {
        ...
        { 
            ...
            int chieucao = Screen.PrimaryScreen.WorkingArea.Height;
            if (isShow == true)
            {

                Point point = new Point(defaultPoint.X + 180 + btn.Location.X, defaultPoint.Y + 180 + btn.Location.Y);
                if (point.Y >= 640)
                    point.Y = 490;
                inpuPad.Location = point; inpuPad.Focus();          
            }
            else
            {
